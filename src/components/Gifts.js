        ...
        <div className="gift-deets">
          <motion.div variants={giftVariants} initial="hidden" whileInView="visible" className="logos">
            <div className="pay-deets">
              <img
                ...
                onMouseOver={handleAirtel}
                onFocus={handleAirtel}
                onKeyDown={(e) => (e.key === 'Enter' || e.key === ' ') && handleAirtel(e)}
                tabIndex="0"
          ...
          <div className="int-deets">
            ...
            <div className="pay-methods">
              ...
              <a
                href="https://www.worldremit.com/en/zambia?amountfrom=100.00&selectfrom=gb&currencyfrom=gbp&selectto=zm&currencyto=zmw&transfer=csh"
                rel="noreferrer"
                target="_blank"
                className="pay-deets"
              >
